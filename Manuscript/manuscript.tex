...
% J: I think the following sentence can be omitted
...
%than in simulations with ECC-POPS (Fig.~\ref{fig:POPS-counterions-dens} and~\ref{fig:delta_ordPar_NaCl_PC-PS_mix_PC}).
...
in ECC-lipids simulation with \ce{Na+} counterions. 
...
in Lipid17/Dang ion simulations with \ce{Na+} counterions.
...
Ad bar plots -- change total to combinations as described in caption, 
add simultaneously to "PC and PS", 
add ticks to the right side of the plot and
change the colour of "combinations" from blue to any other so that it is different from the legend in the other plot. }
\end{figure} 
