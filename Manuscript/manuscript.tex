...
Here, we apply the ECC to the Amber based lipid17 parameters \cite{could18} of POPS lipid with
...
we used the Lipid14 parameters~\cite{dickson14} for POPC, the Lipid17 parameters for POPS \cite{gould18},
...
The ion model by Dang and coworkers was used in these simulations because
the default ion parameters in Amber exhibit clustering in solution with relatively
low concentrations which complicates the evaluation of binding affinity against experiments \cite{nmrlipids_proj4}.
