...
Recent simulations reveal similar trends for the populations at various PS moieties. \cite{valentine18, hallock18}
The results from infrared spectroscopy combined with 
simulations with the CHARMM36 model 
including a correction for overestimated binding of calcium \cite{valentine18}
suggest that POPS interacts mostly through it \ce{COO^-} group. 
In contrast, the combination of NMR experiments 
and MD simulations with the same model but without the correction 
also reveal long-lived interactions of \ce{Ca^{2+}} with \ce{PO4} groups. \cite{hallock18}
The content of POPS in the bilayers in that work is, however, 
...
At such highly charged membranes,
POPS lipids are found to form even four-membered clusters \cite{hallock18}. 
