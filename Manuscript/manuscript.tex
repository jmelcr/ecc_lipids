...
This could be explained by the slightly deeper penetration of potassium into the bilayer (Fig. \ref{fig:delta_ordPar_NaCl_PC-PS_mix_PC}).
...
in ECC-POPS simulations (Figs. \ref{fig:delta_ordPar_monoval_PCPS} and \ref{fig:delta_ordPar_monoval_PCPS}).
