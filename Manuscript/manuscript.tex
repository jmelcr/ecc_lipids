...
\todo{Joe: this figure requires updating and polishing, but serves the purpose of “showing the data”.}
\end{figure} 
...
\begin{figure}[tbp!] 
  ...
  \todo{SAMULI: Top figure should go together with figure of only K+ counterions and figure with pure PS mentioned
    another todo point
  } \\
  \todo{SAMULI: Division of ion densities with 2 in figure without calcium is not necessary and makes
  comparison to other results more difficult.}
\end{figure} 
