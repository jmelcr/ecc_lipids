...
\title[An \textsf{achemso} demo]
  {Binding of cations to Neutral and Negatively Charged Phospholipid Bilayers 
   made accurate through the use of 
   classical fixed-charge MD models with implicit polarizability } 
