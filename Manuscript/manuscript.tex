...
calcium to \ce{PIP_2} lipids inhibits their recognition by a phospolipase C, which demonstrates that not only proteins but also lipids can get involved in calcium 
signaling \cite{Bilkova2017Calcium}.
