...
\centering
  ...
  \begin{tabular}{l|c } 
    ...
    model          & APL / Å$^2$    \\ 
    \hline 
    Lipid17/Dang              & 53.5$\pm$ 0.8   \\ 
    Lipid17/ff99 \todoi{add?} & XX.x$\pm$ 0.8   \\ 
    \hline 
    ECC-POPS/ECC-ions         & 60.3$\pm$ 0.6   \\ 
    \hline 
...
(e.g., incorrect pairing of ions, condensation at larger salt concentrations \cite{kohagen16, chen07}). 
