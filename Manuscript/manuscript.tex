...
order parameters is not observed \cite{NMRlipidsIV}. This is the case in 
Lipid17/Dang ion simulations with \ce{Na+} counterions,
while in simulations with \ce{K+} counterions and in
ECC-lipids simulations both counterions,
...
deeper penetration of \ce{K+} into the bilayer (Fig.~\ref{fig:delta_ordPar_monoval_PCPS}).
...
%	The areas sum up to total populations at the respective lipids. 
  ...
  \todo{All these in the same figure might be too much, maybe the most right panel into a separate figure?} \\
  \todo{In the most right panel, the x-axis label should be changed to ''number of lipids directly bound to Ca$^{2+}$''.
    The current label has currently another meaning in the text.}
\end{figure} 
