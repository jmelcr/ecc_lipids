...
\begin{abstract} 
	\emph{Adapt abstract to the final message: properties of POPS-containing bilayers -or- ECC-concept applicability?}
...
\todo{SAMULI: I can write preliminary version of the introduction asap.}
...
\subsection{Electrometer concept: cationic and anionic amphiphilic molecules} 

\todo{SAMULI: This section should be titled something like ''PS-PC headgroup interactions in mixtures'',
unless we actually run simulations with anionic amphiphilic molecules.} 
...
\begin{figure}[htb!] 
  \centering 
  \includegraphics[width=\figwidthsmall]{../Fig/l17/order_parameters_changes_A-B_PC-PS_mix_POPC_nacl.pdf} 
  \includegraphics[width=\figwidthsmall]{../Fig/l17/order_parameters_changes_A-B_PC-PS_mix_POPS_nacl.pdf} 
...
\todo{SAMULI: It would be probably better to show also here the Lipid17 and ECC results in the same 
  plot as done in the other figures.}
\end{figure} 
