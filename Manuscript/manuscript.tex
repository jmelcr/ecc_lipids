...
\todo{Joe: to be filled-in. I'll generate it automatically from my Jupyter notebooks.}  
\label{tbl:sim-list}
...
MD simulations were performed using the GROMACS \cite{Abraham15} simulation package (version 2018). 
The simulation parameters used in this work are summarized in Table~\ref{tbl:mdpar}. 
A comprehensive list of simulaitons used in this work is in Table~\ref{tbl:sim-list}. 
