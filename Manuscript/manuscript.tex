...
\begin{abstract} 
  ...
  Here, we apply the electronic continuum correction (ECC) to the Amber Lipid17 parameters of 1-palmitoyl-2-oleoyl-{\it sn}-glycero-3-phospho-L-serine (POPS) lipid to improve its
...
\todo{JOE: The given range is not correct, e.g. scaling of POPC (0.89), Mg2+ (0.72 and 0.82). 
...
in the headgroup, glycerol backbone, and carbonyl regions. % added because the information where we scale charges was missing before.
...
in the headgroup, glycerol backbone, and carbonyl regions \cite{melcr18}. % Can be shortened by saying it is the same set as that for scaling charges.
...
\todo{We need sample preparation, temperature and other potentially missing details.}
...
\begin{figure}[tbp!] 
  ...
  \includegraphics[width=7in]{../img/deltaOP_nacl_kcl_PC-PS.pdf} 
...
\begin{figure*}[!tbp] 
  ...
  \includegraphics[width=7in]{../img/deltaOP_mix_PC-PS.pdf} 
...
%SAMULI: I commented this out because the cited reference does not discuss residence times.
...
\begin{figure}[tbp!] 
  ...
  \includegraphics[width=7in]{../img/deltaOP_cacl_PC-PS.pdf} 
  \end{tabular}
%  \begin{tabular}{ c }
...
\begin{figure}[tbp!] 
  ...
  \includegraphics[width=7in]{../img/populations_stoichiometry.pdf} 
  \end{tabular}
  \caption{ \label{fig:cacl_complexes} 
