...
zwitterionic lipids \cite{melcr18}. 
...
a force field with an explicit polarizability 
using the Classical Durde model 
is gradually being developed, however, 
only parameters for PC and PE are available at this moment. \cite{chowdhary13, chowdhary17}
While such a model shows a potential improvement from many perspectives -- 
...
%charged lipids using polarizable force fields. 
%nor about their interactions with cations and anions. 
%From this perspective,
%this work is the first pioneering study providing atomistic resolution insight 
%into the interactions of POPS with monovalent and even divalent cations. 
