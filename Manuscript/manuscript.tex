...
Further optimization of parameters was not done in this work. \cite{ECC-POPC_nacl_cacl2_files}
...
\hfill
  ...
  \todo{The experimental order parameters from sn-1 chain are missing from the figure -- Josef: they are not. the parameters are largely overlapping and also only a few of the parameters were resolved for palmitoyl. They are visible for C15 and C16 as open diamonds. } \\
\end{figure} 
