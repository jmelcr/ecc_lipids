...
\begin{figure}[!h] 
  ...
  \caption{\label{fig:strcutures_SI} 
    ...
    of only one POPS (A), one POPS with one POPC (B) or that of two POPS lipids (C). 
    Plots of probabilities of coordination with different phospholipid moieties 
    and with various number of lipids is in Fig.~\ref{fig:cacl_complexes}. 
  }
\end{figure} 
